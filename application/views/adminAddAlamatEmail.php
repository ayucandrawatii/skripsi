  ...
  <div class="container"  style="width:700px;">
    ...
    <div class="box box-info">
      ...
      <div class="box-header with-border">
        <h1 class="box-title">Add Alamat Email</h1>
      </div>
      <!-- /.box-header -->
      <!-- form start -->

      <form id="submitpengaduan" method="post" action="<?= base_url('AdminNambahAlamatEmail/submit/')?>" class="form-horizontal" style="color:white;">
