      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <a href="<?= site_url('adminPengaduan/cetak/').$bulan.'/'.$tahun ?>" type="button" class="btn btn-primary" style="right">Cetak Pengaduan</a>
            </div>
          </div>
          ...
          <!-- /.box-header -->
            ...
            <div class="col-md-12 text-right">
              <form action="<?php echo base_url('adminPengaduan/pengaduan/') ?>" method="get">
                <label>Search</label>
