            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="<?php echo base_url('TechnicalSupport/editKerusakan/').$post->id ?>" type="button" class="btn btn-default">Edit</a>
                      <a href="<?php echo base_url('TechnicalSupport/deleteKerusakan/').$post->id ?>" type="button" class="btn btn-default">Hapus</a>
                    </div>
                  </td>
                 </tr>
                <?php endforeach ?>
